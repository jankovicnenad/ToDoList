...
public class PriorityRestController {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Fetched all priorities from database", content = {@Content(mediaType = "application/json")})})
    @GetMapping("/priority")
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Fetched priority from database by specific ID", content = {@Content(mediaType = "application/json")})})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Inserted priority to database", content = {@Content(mediaType = "application/json")})})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Updated priority in database", content = {@Content(mediaType = "application/json")})})
    @PutMapping("/priority")
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Deleted priority from database", content = {@Content(mediaType = "application/json")})})
